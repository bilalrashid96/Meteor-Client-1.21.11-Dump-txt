...
public class BaritoneSettings implements IPathManager.ISettings {
   ...
   private void createWrappers() {
      ...
      try {
         Class<? extends Settings> klass = BaritoneAPI.getSettings().getClass();
            ...
            if (!Modifier.isStatic(field.getModifiers())) {
               ...
               if (obj instanceof Settings.Setting) {
                  ...
                  if (value instanceof Boolean) {
                     Setting<Boolean> wrapper = sgBool.add(((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((Boolean)setting.defaultValue)).onChanged((aBoolean) -> setting.value = aBoolean)).onModuleActivated((booleanSetting) -> booleanSetting.set((Boolean)setting.value))).build());
                     switch (wrapper.name) {
                     ...
                     sgDouble.add(((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)(new DoubleSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((Double)setting.defaultValue).max((Double)SETTING_MAX_VALUES.getOrDefault(setting.getName(), (double)10.0F)).sliderMax((Double)SETTING_MAX_VALUES.getOrDefault(setting.getName(), (double)10.0F)).onChanged((aDouble) -> setting.value = aDouble)).onModuleActivated((doubleSetting) -> doubleSetting.set((Double)setting.value))).build());
                  } else if (value instanceof Float) {
                     sgDouble.add(((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)((DoubleSetting.Builder)(new DoubleSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue(((Float)setting.defaultValue).doubleValue()).max((Double)SETTING_MAX_VALUES.getOrDefault(setting.getName(), (double)10.0F)).sliderMax((Double)SETTING_MAX_VALUES.getOrDefault(setting.getName(), (double)10.0F)).onChanged((aDouble) -> setting.value = aDouble.floatValue())).onModuleActivated((doubleSetting) -> doubleSetting.set(((Float)setting.value).doubleValue()))).build());
                  } else if (value instanceof Integer) {
                     Setting<Integer> wrapper = sgInt.add(((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((Integer)setting.defaultValue)).onChanged((integer) -> setting.value = integer)).onModuleActivated((integerSetting) -> integerSetting.set((Integer)setting.value))).build());
                     if (wrapper.name.equals("maxFallHeightNoWater")) {
                        this.noFall = ((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)((BoolSetting.Builder)(new BoolSetting.Builder()).name(wrapper.name)).description(wrapper.description)).defaultValue(false)).onChanged((aBoolean) -> wrapper.set(aBoolean ? 159159 : (Integer)wrapper.getDefaultValue()))).onModuleActivated((booleanSetting) -> booleanSetting.set((Integer)wrapper.get() >= 255))).build();
                     }
                  } else if (value instanceof Long) {
                     sgInt.add(((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)((IntSetting.Builder)(new IntSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue(((Long)setting.defaultValue).intValue())).onChanged((integer) -> setting.value = integer.longValue())).onModuleActivated((integerSetting) -> integerSetting.set(((Long)setting.value).intValue()))).build());
                  } else if (value instanceof String) {
                     sgString.add(((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)((StringSetting.Builder)(new StringSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue((String)setting.defaultValue)).onChanged((string) -> setting.value = string)).onModuleActivated((stringSetting) -> stringSetting.set((String)setting.value))).build());
                  } else if (value instanceof Color) {
                     Color c = (Color)setting.value;
                     sgColor.add(((ColorSetting.Builder)((ColorSetting.Builder)((ColorSetting.Builder)((ColorSetting.Builder)(new ColorSetting.Builder()).name(setting.getName())).description(getDescription(setting.getName()))).defaultValue(new SettingColor(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha())).onChanged((color) -> setting.value = new Color(color.r, color.g, color.b, color.a))).onModuleActivated((colorSetting) -> colorSetting.set(new SettingColor(c.getRed(), c.getGreen(), c.getBlue(), c.getAlpha())))).build());
   ...
   static {
      SETTING_MAX_VALUES.put("pathCutoffFactor", (double)1.0F);
   }
}
